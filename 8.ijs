...
wd 'set Q_E1 tooltip еквівалентна кількість НХР у первинній хмарі'
wd 'set Q_E2 tooltip еквівалентна кількість речовини у вторинній хмарі'
wd 'set Г1 tooltip глибина зони хімічного зараження первинною хмарою'
wd 'set Г2 tooltip глибина зони хімічного зараження вторинною хмарою'

wd 'set Гр tooltip повна глибина зони зараження'
wd 'set Гп tooltip максимально можливе значення глибини переносу повітряних мас'
wd 'set Г12 tooltip більша за розміром Г1 і Г2'
wd 'set Г21 tooltip менша за розміром Г1 і Г2'

wd 'set Гпзхз tooltip кінцева розрахункова глибина зони зараження'
wd 'set Sпзхз tooltip площа зони фактичного зараження'
wd 'set Sзмхз tooltip площа зони можливого зараження'

wd 'set t_під tooltip час підходу'
wd 'set t_ур tooltip тривалість випаровування речовини'
